...
<style lang="stylus" scoped>
  ...
  .mooc-button
    ...
    &.mooc-button-size-medium
      ...
      &.is-round
        padding: $button-size-medium-vertical-padding $button-size-medium-horizontal-padding;
    &.mooc-button-size-small
      ...
      &.is-round
        padding: $button-size-small-vertical-padding $button-size-small-horizontal-padding;
    &.mooc-button-size-mini
      ...
      &.is-round
        padding: $button-size-mini-vertical-padding $button-size-mini-horizontal-padding;
    &.is-round
      padding: $button-round-default-vertical-padding $button-round-default-horizontal-padding;
